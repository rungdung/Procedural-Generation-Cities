...
rule buildType1 weight 0.7 maxdepth 2 > type1EndRule{
	...
	{ color random alpha 0.7 s 1 1 floorHeightTypeOne} box //build floor
	//facade
	{}type1Facade
}
...
rule type1EndRule md 5{
	{ z 5 s 0.9 0.2 0.8 color random alpha 0.1} box//build floor top
	{ z 0.9 }type1EndRule
}
rule type1EndRule md 5{
	{ z 5 s 0.9 0.2 0.8 color random alpha 0.001} box//build floor top
	{ z 0.9 }type1EndRule
}

rule type1Facade w 0.1 md 10 {
	{ z 0.1 s 0.4 1.1 0.8 color random } box
	{ z 0.4 s 1.01 1.01 1} type1Facade
}
rule type1Facade w 0.2 md 15 {
	{ y 0.1 z 0.1 s 0.4 1.1 0.8 color random } box
	{ z 0.4 s 0.87 0.98 1} type1Facade
}
rule type1Facade w 0.1 md 20 {
	{ x 0.1 z 0.1 s 0.4 1.1 0.8 color random } box
...
rule buildType3 maxdepth 5 weight 0.5{
	...
	{ color random alpha 0.4 s 1 1 floorHeightTypeThree } box
	//facade
		//windows 
	{}type3Facade
}
rule buildType3 maxdepth 3{
	{ z floorHeightTypeThree } buildType3
	{ color random alpha 0.7 s 1 1 floorHeightTypeThree } box
	//facade
		//windows 
	{}type3Facade
}
rule buildType3 maxdepth 3{
	{ z floorHeightTypeThree } buildType3
	{ color random s 1 1 floorHeightTypeThree } box
	//facade
		//windows 
	{}type3Facade
}
...
rule type3EndRule md 5{
	{ z 5 s 0.9 0.2 0.8 color yellow alpha 0.001} mesh//build floor top
	{ z 0.9 }type3EndRule
}
rule type3EndRule md 5{
	{ z 5 s 0.9 0.2 0.8 color blue alpha 0.001} box//build floor top
	{ z 0.9 }type3EndRule
}

rule type3Facade md 10 {
	{ color random s 0.7 1.4 1} box
}
rule type3Facade md 15 {
	{ z 0.1 color random s 1 1.4 0.5} box
}
rule type3Facade w 0.1 md 20{
	{ y 0.1 color random s 1 0.2 1} box
}
...
rule buildUtilityStation w 2{
	{ s 4 z 0.1 color grey blend green 0.6 } box
}
...
rule buildTree {
	{ z -0.5 s 6 6 0.7 color green blend brown 0.8}box
	{ rx 180 s 0.9 x 2 y 3 } R1
	{ x 5}buildTree
}
rule buildTree {
	{ z -0.5 s 6 6 0.7 color green blend yellow 0.8}box
...
rule buildTree{
	{ z -0.5 s 6 6 0.2 color green blend yellow 0.2}box
	{ rx 160 s 0.8  } R1
}
rule buildTree{
	{ z -0.5 s 6 6 0.2 color green}box
...
//-----------------------------------------------------------------------------------
rule endrule {
	{ s 5 color green blend brown 0.7} box
}
rule endrule {
	{ s 5 color green alpha 0.6 blend brown 0.2} sphere
}
rule endrule {
	{ s 3 hue 56 blend violet 0.8 } sphere
}
rule endrule {
	{ s 4 hue 56 } sphere
}